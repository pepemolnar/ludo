...
import { IPosition, PositionType } from '../../types/gameTypes';
import { TPlayerColor } from '../../types/playerTypes';
...
export class Figure implements IFigure {
  ...
  step(numberOfSteps: number, numberOfFields: number): IPosition {
    const newPosition: IPosition = this.getNewPosition(
      numberOfSteps,
      numberOfFields
    );
  ...
  getNewPosition(numberOfSteps: number, numberOfFields: number): IPosition {
